...
public class Speech {
    ...
    private boolean mPreferOffline=true;
        ...
        public void onInit(final int status) {
            switch (status) {
                case TextToSpeech.SUCCESS:
                    Log.e("log_voc_tts", "engine successfully started!!");
                    break;

                case TextToSpeech.ERROR:
                    Log.e("log_voc_tts", "Error while initializing TextToSpeech engine!");
                    break;

                default:
                    Log.e("log_voc_tts", "Unknown TextToSpeech status: " + status);
                    break;
            }
        }
    };
    ...
    private final RecognitionListener mListener = new RecognitionListener() {
        ...
        public void onReadyForSpeech(final Bundle bundle) {
            ...
            mPartialData.clear();
            mUnstableData = null;
            Log.e("log_voc_set_Offline", mPreferOffline+"");
        }

        @Override
        public void onBeginningOfSpeech() {
            Log.e("log_test", "onBeginningOfSpeech");
        ...
        @Override
        //TODO 2월14일 여기 음성 한번 봐보셈. 에러 어디서 뜨는지 찾아야함 . 찾고 그자리 예외처리하세요.
        public void onRmsChanged(final float v) {
            try {
                if (mDelegate != null) mDelegate.onSpeechRmsChanged(v);
            } catch (final Throwable exc) {
                Log.e("log_voc_rms","onRmsChanged-catch");
            }
            if (mProgressView != null){
                Log.e("log_voc_rms","onRmsChanged if2222");
                mProgressView.onRmsChanged(v);//평상시 안들어감
            }
        }
        ...
        public void onPartialResults(final Bundle bundle) {
            ...
            if (partialResults != null && !partialResults.isEmpty()) {
                ...
                try {
                    ...
                    Log.e("log_voc_cat","Unhandled exception in delegate onSpeechPartialResults", exc);
                }
            }
        }
        ...
        public void onResults(final Bundle bundle) {
            ...
            if (results != null && !results.isEmpty()
                ...
                Log.e("log_voc_cat","No speech results, getting partial");
            ...
            try {
                if (mDelegate != null){ //말하면 널아님
                    mDelegate.onSpeechResult(result.trim());
                }
                else{
                    mDelegate.onSpeechResult(" ");
                }
            } catch (final Throwable exc) {
                Log.e("log_voc_cat","Unhandled exception in delegate onSpeechResult  "+exc);
            }
...
//            }
        ...
        public void onError(final int code) {
            returnPartialResultsAndRecreateSpeechRecognizer(); //TODO 주석처리 해놨음
//            Log.e("log_voc_set", "4");
//            Logger.error(LOG_TAG, "Speech recognition error", new SpeechRecognitionException(code));
    ...
    private void initSpeechRecognizer(final Context context) {
        if (context == null){
            Log.e("log_voc_set", "context must be defined!");
        ...
        if (SpeechRecognizer.isRecognitionAvailable(context)) {
            if (mSpeechRecognizer != null) {
                try {
                    ...
                    Log.e("log_voc_set", "Non-Fatal error while destroying speech. " + exc.getMessage());
            ...
            Log.e("log_voc_","initSpeechRecognizer out");

        } else {
            mSpeechRecognizer = null;
            Log.e("log_voc_","initSpeechRecognizer else");
        }
     ...
     * @throws GoogleVoiceTypingDisabledException when google voice typing is disabled on the device
     */
    public void startListening(final SpeechProgressView progressView, final SpeechDelegate delegate) //TODO 여기서 잘 봐야함 어디서 멈추는지
            throws SpeechRecognitionNotAvailable, GoogleVoiceTypingDisabledException {
...
//        }
        ...
        try {
            ...
            Log.e("log_voc_set", "Unhandled exception in delegate onStartOfSpeech"+ exc);
        }
    }
    ...
    public void stopListening() {
        ...
        if (throttleAction()) {
            Log.e("log_voc_stop","Hey man calm down! Throttling stop to prevent disaster!");
        }
    ...
    private void returnPartialResultsAndRecreateSpeechRecognizer() {
        ...
        try {
            ...
            Log.e("log_voc_set_return","Unhandled exception in delegate onSpeechResult");
        }
        ...
        initSpeechRecognizer(mContext); //여기서 재생성
        Log.e("log_voc_stop","==================================================");
    }
    ...
    public void stopTextToSpeech() {
        Log.e("log_voc_set","stopTextToSpeech11");
        if (mTextToSpeech != null) {
            mTextToSpeech.stop();
            Log.e("log_voc_set","stopTextToSpeech22");
        }
    }
